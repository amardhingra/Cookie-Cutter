...
public class ShapeGenerator {
    ...
    private static Shape[] eightShapes = {generateY(), generateF(8), generateLine(8), generateL()};
    private static int eightPos = 0;

    private static Shape[] fiveShapes = {generatePlus(), generateU(), generateT(), generateLine(5), generateBlock()};
